...
Welcome to my primary Data Analytics portfolio repository! This space showcases end-to-end data analytics projects—ranging from exploratory relational database queries and data cleaning in SQL to interactive dashboarding and reporting in Excel and Tableau.

---

## 🛠️ Tools & Technologies Used
* **Database Management & SQL:** Microsoft SQL Server Management Studio (SSMS)
* **Data Visualization & Dashboards:** Tableau Public, Microsoft Excel (Pivot Tables, Dynamic Slicers)
* **Version Control:** Git, GitHub
* **Up Next:** Power BI, Python Data Analysis (`pandas`, `numpy`, `matplotlib`, `seaborn`)
...
| :--- | :--- | :--- | :--- |
| **Tableau** | **Seattle Airbnb Market & Revenue Analysis** | Geographic Mapping, Capacity Pricing, Revenue Seasonality | [View Tableau Project](./Tableau_Projects/) |
...
Portfolio-Projects/
│
├── README.md                              <-- Master Portfolio Landing Page
│
├── Tableau_Projects/                      <-- Tableau Project Directory
│   ├── AirBnB Project.twb                 <-- Tableau Workbook File
│   ├── dataset_airbnb.xlsx                <-- Source Airbnb Excel Workbook
